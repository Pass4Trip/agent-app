...
async def _merge_edges_then_upsert(
    ...
    description = await _handle_entity_relation_summary((src_id, tgt_id), description, global_config)
...
async def _find_most_related_entities_from_relationships(
    ...
    node_datas = [
        {**n, "entity_name": k, "rank": d} for k, n, d in zip(entity_names, node_datas, node_degrees)
    ]
