...
def envoyer_message(message, agent_id="example-agent", session_id="vinh_session_id", user_id="vinh_id", url="http://vps-af24e24d.vps.ovh.net/v1/playground/agent/run"):
    """
